...
if($_POST['data']) {
    ...
    try {
        ...
        $m = new Mail; // начинаем
        $m->From( "OGAVA;marketing@kvott.ru" ); // от кого отправляется почта
        $m->To( "marketing@kvott.ru" ); // кому адресованно
        ...
        $m->smtp_on("ssl://smtp.yandex.ru", "LOGIN", "PASS" , 465) ; // если указана эта команда,
        // отправка пойдет через SMTP  //ssl://
